...
function Footer() {
    return (
        <div className='container'>
            ...
            <div className='col'>
                 <img
            src="media/images/stock-trade.svg"
            style={{ width: "50%" }}
          />
          <p> 
           ...
           <p>vestments in securities market are subject to market risks; read all the related documents carefully before investing.</p>
